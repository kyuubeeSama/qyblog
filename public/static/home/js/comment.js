...
function comment(e) {
    $.post(check_login, function (t) {
        if (1 == t) {
            ...
            if ("" != a && "请先登录后发表评论" != a) {
                var i = $(e).attr("aid"), l = $(e).attr("pid"),
                    s = $(e).parents(".b-box-textarea").eq(0).find("input[name='email']").val(),
                    n = {aid: i, pid: l, content: a, email: s};
                layer.load(1), $.post(ajaxCommentUrl, n, function (t) {
                    var s = t, n = $(e).attr("username"), o = new Date,
