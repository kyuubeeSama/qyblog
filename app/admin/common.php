...
function add_water($path){
	...
	if(Config::get('webconfig.WATER_TYPE')==1){
		// 添加文字水印
		$image->open($path)->text(Config::get('webconfig.TEXT_WATER_WORD'),Config::get('webconfig.TEXT_WATER_TTF_PTH'),Config::get('webconfig.TEXT_WATER_FONT_SIZE'),Config::get('webconfig.TEXT_WATER_COLOR'),Config::get('webconfig.TEXT_WATER_LOCATE'),0,Config::get('webconfig.TEXT_WATER_ANGLE'))->save($path);
	}elseif(Config::get('webconfig.WATER_TYPE')==2){
		// 添加图片水印
		$image->open($path)->water(Config::get('webconfig.IMAGE_WATER_PIC_PTAH'),Config::get('webconfig.IMAGE_WATER_LOCATE'),Config::get('webconfig.IMAGE_WATER_ALPHA'))->save($path);
	}elseif(Config::get('webconfig.WATER_TYPE')==3){
		// 添加图片和文字水印
		$image->open($path)->text(Config::get('webconfig.TEXT_WATER_WORD'),Config::get('webconfig.TEXT_WATER_TTF_PTH'),Config::get('webconfig.TEXT_WATER_FONT_SIZE'),Config::get('webconfig.TEXT_WATER_COLOR'),Config::get('webconfig.TEXT_WATER_LOCATE'),0,Config::get('webconfig.TEXT_WATER_ANGLE'))->save($path);
		$image->open($path)->water(Config::get('webconfig.IMAGE_WATER_PIC_PTAH'),Config::get('webconfig.IMAGE_WATER_LOCATE'),Config::get('webconfig.IMAGE_WATER_ALPHA'))->save($path);
	}
...
function send_email($address,$subject,$content){
	...
	$email_username=Config::get('webconfig.EMAIL_USERNAME');
